...
// in simulator we redefine to format for Persistence Developer console
...
{\
	NSString * exceptionName = [@"org.persistence." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.persistence";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIPersistenceNativeItemNone = -1, 
	UIPersistenceNativeItemSpinner = -2,
	UIPersistenceNativeItemProgressBar = -3,
	
	UIPersistenceNativeItemSlider = -4,
	UIPersistenceNativeItemSwitch = -5,
	UIPersistenceNativeItemMultiButton = -6,
	UIPersistenceNativeItemSegmented = -7,
	
	UIPersistenceNativeItemTextView = -8,
	UIPersistenceNativeItemTextField = -9,
	UIPersistenceNativeItemSearchBar = -10,
	
	UIPersistenceNativeItemPicker = -11,
	UIPersistenceNativeItemDatePicker = -12,
	
	UIPersistenceNativeItemInfoLight = -13,
	UIPersistenceNativeItemInfoDark = -14,
	
	UIPersistenceNativeItemDisclosure = -15,
	
	UIPersistenceNativeItemContactAdd = -16
};
